export default [
    ...
    {
        order: 'Third',
        title: 'Strategic Outsourcing -<br> 商业外包',
        title_cn: '商业外包',
        desc: '美术设计是空鸟文化核心业务，我们专注于项目方的独特需求。凭借专业素养和美术创意，量身打造充满创意的视觉设计，我们将在产品制作的各个阶段，将繁杂的设计巧妙提升至理性思维的高度，为每一个项目注入独特的灵魂',
